...
from depth_first_toposort_recursive import DepthFirstTopoSortRecursive
...
class DepthFirstSCC:
    ...
    def __init__(self, graph):
        ...
        toposort = DepthFirstTopoSortRecursive(DiGraph.reverse(graph))
