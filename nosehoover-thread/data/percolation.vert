...
out vec4 v_lattice_normal;
out vec4 v_lattice_color;
out vec2 v_lattice_texcoord;
...
void main(void)
{
    ...
    v_lattice_normal = vec4(lattice_normal, 1.0);
    v_lattice_color = vec4(lattice_color, 1.0);
    v_lattice_texcoord = lattice_texcoord;
}
