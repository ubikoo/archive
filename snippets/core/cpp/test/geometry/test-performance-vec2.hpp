...
#ifndef TEST_CORE_GEOMETRY_PERFORMANCE_VEC2_H_
#define TEST_CORE_GEOMETRY_PERFORMANCE_VEC2_H_

#include "test-common.hpp"

/** ---------------------------------------------------------------------------
 * test_performance_vec2
 * @brief vec2d performance test.
 */
core_inline_
void test_performance_vec2 (const size_t n_items, const double maxeps)
{
    const size_t dim = 2;
    const core::math::vec2d zero(0.0);
    const core::math::vec2d one(1.0);
    const core::math::vec2d two(2.0);

    /*
     * Create an array of vectors
     */
    core::align_unique_array<core::math::vec2d> a_arr =
        core::make_align_unique_array<core::math::vec2d>(n_items, 1.0);
    core::align_unique_array<core::math::vec2d> b_arr =
        core::make_align_unique_array<core::math::vec2d>(n_items, 2.0);
    core::align_unique_array<core::math::vec2d> c_arr =
        core::make_align_unique_array<core::math::vec2d>(n_items, 0.0);
    ...
    for (size_t ix = 0; ix < n_items; ++ix) {
        core::math::vec2d *a = (*a_arr) + ix;
        core::math::vec2d *b = (*b_arr) + ix;
        core::math::vec2d *c = (*c_arr) + ix;

        size_t id = omp_get_thread_num();
        core::math::RngKiss *kiss = (*kiss_arr) + id;
        core::math::RngDist *rng = (*rng_arr) + id;

        *a = core::math::vec2d((*rng).nrand(*kiss)*rand_sdev + rand_avg,
...
#endif /* TEST_CORE_GEOMETRY_PERFORMANCE_VEC2_H_ */
