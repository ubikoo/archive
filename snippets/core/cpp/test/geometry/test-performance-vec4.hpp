...
{
    const size_t dim = 4;
    const core::math::vec4d zero(0.0);
    const core::math::vec4d one(1.0);
    const core::math::vec4d two(2.0);

    /*
     * Create an array of vectors
     */
    core::align_unique_array<core::math::vec4d> a_arr =
        core::make_align_unique_array<core::math::vec4d>(n_items, 1.0);
    core::align_unique_array<core::math::vec4d> b_arr =
        core::make_align_unique_array<core::math::vec4d>(n_items, 2.0);
    core::align_unique_array<core::math::vec4d> c_arr =
        core::make_align_unique_array<core::math::vec4d>(n_items, 0.0);
    ...
    for (size_t ix = 0; ix < n_items; ++ix) {
        core::math::vec4d *a = (*a_arr) + ix;
        core::math::vec4d *b = (*b_arr) + ix;
        core::math::vec4d *c = (*c_arr) + ix;

        size_t id = omp_get_thread_num();
        core::math::RngKiss *kiss = (*kiss_arr) + id;
        core::math::RngDist *rng = (*rng_arr) + id;

        *a = core::math::vec4d((*rng).nrand(*kiss)*rand_sdev + rand_avg,
